...
public:
    ...
    recursive_filter_iterator(fs::path filename_to_skip, fs::path start_point,
...
private:
    ...
    bool should_skip(const fs::path& p) { return p.filename() == m_filename_to_skip; }
...
public:
    ...
    recursive_filter_iterator end() const { return recursive_filter_iterator{}; }
};
